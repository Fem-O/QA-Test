...
test('test', async ({ page }) => {
  ...
  // Click text=Book >> class using xpath  (Book new appointment for 1st patient with Medical Record Number alt00107)
  ...
  // Click text=Book >> nth=3 (Book new appointment for 2nd patient with Medical Record Number alt00108)
  ...
  // Click text=Book >> nth=4  (Book new appointment for 3rd patient with Medical Record Number alt00109)
